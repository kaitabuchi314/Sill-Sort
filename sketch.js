...
function displayBars() {
  for (let i = 0; i < values.length; i++) {
    ...
    stroke(map(values[i], 0, height, 0, 255) * 1.5, map(values[i], 0, height, 0, 255) * 1.2, map(values[i], 0, height, 0, 255) * 2);
    let x = i * barWidth;
    let y = height - barHeight;
    fill(map(values[i], 0, height, 0, 255) * 1.5, map(values[i], 0, height, 0, 255) * 1.2, map(values[i], 0, height, 0, 255) * 2);
